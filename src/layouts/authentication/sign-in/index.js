...
//     const res = await axios.get(`http://localhost:7000/users?email=${email}&password=${password}`);
...
function Basic() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:7000/users", { email, password });
