...
const AddUser = () => {
  ...
  //   const modulesData = { modules: userData.modules };
  //   console.log(modulesData, "Modules");
  //   axios
  //     .post("http://localhost:4000/users/modules", modulesData) // Assuming a separate endpoint for saving modules
  //     .then((res) => {
  //       console.log("Modules Saved:", res);
  //     })
  //     .catch((error) => console.log(error));
  // };
